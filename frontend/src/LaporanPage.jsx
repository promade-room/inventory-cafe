        ...
        <>
          ...
          {activeTab === 'movement' && movement && (
            <div className="space-y-6">
              {/* Line Chart - Movement 7 Hari */}
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h3 className="font-semibold mb-4 text-gray-800">Grafik Pergerakan Stok (7 Hari Terakhir)</h3>
                <div className="h-64">
                  <Line
                    data={{
                      ...
                      datasets: [
                        {
                          label: 'Barang Masuk',
                          data: movement.masuk.map(m => m.masuk || 0),
                          borderColor: '#10B981',
                        ...
                        {
                          label: 'Barang Keluar',
                          data: movement.keluar.map(k => k.keluar || 0),
                          borderColor: '#F59E0B',
              ...
              {/* Bar Chart - Top Keluar */}
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h3 className="font-semibold mb-4 text-gray-800">Top 10 Barang Paling Banyak Keluar</h3>
                <div className="h-64">
                  <Bar
                    data={{
                      ...
                      datasets: [{
                        label: 'Jumlah Keluar',
                        data: movement.top_keluar.slice(0, 10).map(t => t.total_keluar),
